...
add_image_size( 'td_233x217', 233, 217, true );
add_image_size( 'td_994x352', 994, 352, true );
add_image_size( 'td_696x385', 696, 385, true );
add_image_size( 'td_473x237', 473, 237, true );



add_theme_support( 'post-formats', array(  'audio', 'video', 'image', 'link','quote', 'chat' ) );
